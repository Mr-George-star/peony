...
public class PeonyClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(PeonyBlocks.GAS_CYLINDER, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(PeonyBlocks.GAS_STOVE, RenderLayer.getCutout());
