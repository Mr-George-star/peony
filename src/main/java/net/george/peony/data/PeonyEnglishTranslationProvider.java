...
public class PeonyEnglishTranslationProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(PeonyTranslationKeys.JADE_SKILLET_CONTINUE, "Add any ingredient to proceed to the next step, at %d second(s), %d second(s) left");
        translationBuilder.add(PeonyTranslationKeys.JADE_SKILLET_HEATING_TIME, "Cooking, at %d second(s), %d second(s) left");
        translationBuilder.add(PeonyTranslationKeys.JADE_SKILLET_OVERFLOW_TIME, "Timed Out! At %d second(s), %d second(s) left");
        translationBuilder.add(PeonyTranslationKeys.JADE_SKILLET_STIR_FRYING_COUNT, "Stir-frying, needs %d time(s), %d time(s) left");
