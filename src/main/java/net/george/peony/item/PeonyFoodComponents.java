...
public class PeonyFoodComponents {
    ...
    public static final FoodComponent SCRAMBLED_EGGS_WITH_TOMATOES = createPlate().nutrition(10).saturationModifier(0.9F).build();
    ...
    public static final FoodComponent SWEET_AND_SOUR_PORK = createPlate().nutrition(11).saturationModifier(0.9F).build();
    ...
    public static final FoodComponent PORK_TENDERLOIN = new FoodComponent.Builder().nutrition(3).saturationModifier(0.5F).build();
